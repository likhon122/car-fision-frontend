...
const ProductPage = () => {
  ...
  const [priceRange, setPriceRange] = useState<[number, number]>([1, 100000000]);
  ...
  return (
    <div className="py-24 bg-[#F9F9FB] min-h-screen ">
        ...
        {isFetching ? (
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            <aside className="bg-white shadow-lg rounded-lg p-6 h-full w-full lg:w-1/4">
              <div className="mb-6">
                <Input
                  placeholder="Search by category, brand, name etc."
                  value={searchTerm}
